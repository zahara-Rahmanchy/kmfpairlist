...
import PairListLearning from "./components/PairListLearning";
    ...
    <Router>
      <div className="slider-container flex flex-col justify-center items-center mt-10 w-full">
        <nav className="flex gap-4 mb-5">
          <Link to="/" className="bg-indigo-900 text-white px-4 py-2 rounded">
            Pair List
          </Link>
          <Link
            to="/quiz"
        ...
        <Routes>
          <Route path="/" element={<PairListLearning />} />
